class users::add (
  ...
  String $root_home_dir = '/root',
  String $user_home_location = '/home',
) {
  ...
  $groups = hiera_hash( 'users::add::groups', {} )
  ...
  $users = hiera_hash( 'users::add::users', {} )
  $users_keys = hiera( 'users::add::keys', [] )
